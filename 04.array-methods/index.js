...
//   let count = 0
//   arr.forEach((element) =>  element.name.startsWith("t") && element.name.endsWith("t") && count++)
//   console.log(count);
...
//   let sum = 0
//   arr.forEach((element) => sum+=(element.name.startsWith("t") && element.name.endsWith("t")) ? element.key : 0 )
//   console.log(sum);
  

  // 4) "name"-i "e" herfi ile biten obyeklerdeki name-in deyerini "SuperDev" sozu ile evezleyin.

//   arr.forEach((element) => element.name.endsWith("e") && (element.name = "SuperDev"))
//   console.log(arr);
  

  // 5) "name"-i en uzun olan obyekti tapin

//   const longestnameobject = arr.reduce((element, longest) => {
...
//   const longestnamekey= arr.reduce((element, longest) => {
//     return element.name.length > longest.name.length ? element : longest;
//   } ,arr[0])
//   console.log(longestnamekey.key);

  // 7)  "name"-i en uzun ola n obyektin indexin kvadratini hesablayin

//   let  longestIndex = arr.reduce((longest, element, index) => {
//     return element.name.length > arr[longest].name.length ? index : longest;
//   }, 0);
...
//   const result = arr.filter((element) => element.name.length == 4)
//   console.log(result);
  

  // 9)  en boyuk "key" - i olan obyektin "name"-i ni tapin

//   const objectMaxKey = arr.reduce((element, max) => { return element.key > max.key ? element : max;
//   })
//   console.log(objectMaxKey.name);
...
//   const result = arr.filter((element) => element.key > 10 && element.name.startsWith("l") )
//   console.log(result);
...
// const result = products.filter((element) => element.rating.rate > 3);
// console.log(result);
...
// let sum = 0
// const totalPrice = products.forEach((element) => sum += element.price)
// console.log(sum);
...
//     product.category === "electronics" && (product.price *= 0.5)
//   );
